...
if (isset($_POST['upload'])) {
    $targetDirectory = "uploads/";  // Specify the directory where the file will be uploaded
    $targetFile = $targetDirectory . basename($_FILES["images"]["name"]);  // Get the file name with extension
    ...
    if (!empty($_FILES["file"]["tmp_name"])) {
        ...
        if (file_exists($targetFile)) {
            ...
            if (move_uploaded_file($_FILES["file"]["tmp_name"], $targetFile)) {
                // File uploaded successfully, redirect to page 3
