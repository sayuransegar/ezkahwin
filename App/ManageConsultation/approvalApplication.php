                            ...
                            <form class="row g-3" method="POST" action="../../../ezkahwin/index.php">
                                ...
                                <?php foreach ($complaintData as $complaint) { ?>
                                    <div class="mb-3 row" style="margin-top: 10px;">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" id="complaint_date" name="complaint_date" value="<?php echo isset($complaint['complaint_date']) ? $complaint['complaint_date'] : ''; ?>">
                                        </div>
                                        <label for="complaint_desc" class="col-sm-2 col-form-label">Penerangan Aduan</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" id="complaint_desc" name="complaint_desc" rows="5"><?php echo isset($complaint['complaint_desc']) ? $complaint['complaint_desc'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                <?php } ?>
