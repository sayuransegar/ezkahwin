...
<body class="page-bg">
  <div>
    ...
    <section class="register-body">
      <form name="register-form" action="registerController.php" method="POST" onsubmit="return validateRegisterForm()" class="register-form">
        ...
        <input type="text" id="name" name="name" placeholder="Nama" required class="input-field" />
        <select name="gender" id="gender" class="input-field">
          <option value="" disabled selected>-- Sila Pilih Jantina --</option>
          <option value="lelaki">Lelaki</option>
          <option value="perempuan">Perempuan</option>
        </select>
        <input type="text" id="phonenum" name="phonenum" placeholder="No. Telefon" required class="input-field" />
        <input type="text" id="address" name="address" placeholder="Alamat Surat-Menyurat" required class="input-field" />
        <input type="password" id="password" name="password" placeholder="Kata Laluan" class="input-field" required />
