...
<header class="site-header" id="headerBanner"> 
	...
	<div class="content-area">
     ...
     <form action="index.php?action=submitWitness" method="POST">

                    <div class="formgroup">
        				<p>No Kad Pengenalan </p>
        				<input type="text" name="witness_ID1" placeholder="Hospital Sultan Haji Ahmad Shah, Temerloh" />
        			</div>
					<div class="formgroup">
        				<p>Nama Saksi 1</p>
        				<input type="text" name="witness_name1" placeholder="Hospital Sultan Haji Ahmad Shah, Temerloh" />
        			</div>
					<div class="formgroup">
        				<p>Alamat Semasa </p>
        				<input type="text" name="witness_address1" placeholder="Hospital Sultan Haji Ahmad Shah, Temerloh" />
        			</div>
					<div class="formgroup">
        				<p>No Telefon </p>
        				<input type="tel" name="witness_phone_number1" placeholder="013-9868652" />
        			</div>
                ...
                <div class="formgroup">
        				<p>No Kad Pengenalan </p>
        				<input type="text" name="witness_ID2" placeholder="Hospital Sultan Haji Ahmad Shah, Temerloh" />
        			</div>
					<div class="formgroup">
        				<p>Nama Saksi 2 </p>
        				<input type="text" name="witness_name2" placeholder="Hospital Sultan Haji Ahmad Shah, Temerloh" />
        			</div>
					<div class="formgroup">
        				<p>Alamat Semasa </p>
        				<input type="text" name="witness_address2" placeholder="Hospital Sultan Haji Ahmad Shah, Temerloh" />
        			</div>
					<div class="formgroup">
        				<p>No Telefon </p>
        				<input type="tel" name="witness_phone_number2" placeholder="013-9868652" />
        			</div>
