...
<header class="site-header" id="headerBanner"> 
  ...
  <div class="formTitle">
     ...
     <form action="index.php?action=submitMarriage" method="POST">

                

                <div class="formgroup">
        				<p>Tarikh Perkahwinan </p>
        				<input type="date" name="soleminization_date" placeholder="1993-02-01" />
        			</div>
                    <div class="formgroup">
        				<p>Tarikh Daftar Kahwin </p>
        				<input type="date" name="marriage_date" placeholder="1993-02-01" />
        			</div>
                    <div class="formgroup">
        				<p>Nilai Mas Kahwin </p>
        				<input type="text" name="ammount_downry" placeholder="930201-06-0313" />
        			</div>
        			<div class="formgroup">
        				<p>Alamat Pernikahan </p>
        				<input type="text" name="marriage_address" placeholder="Muhammad Azam bin Mahmood" />
        			</div>
