...
<header class="site-header" id="headerBanner"> 
  ...
  <div class="formTitle">
     ...
     <form action="index.php?action=submitCourse" method="POST">

                

                <div class="formgroup">
        				<p>Tarikh Kursus </p>
        				<input type="date" name="course_date" placeholder="1993-02-01" />
        			</div>
                    <div class="formgroup">
        				<p>Daerah Kursus </p>
        				<input type="date" name="course_location" placeholder="1993-02-01" />
        			</div>
                    <div class="formgroup">
        				<p>Alamat Tempat Kursus </p>
        				<input type="text" name="course_address" placeholder="930201-06-0313" />
        			</div>
